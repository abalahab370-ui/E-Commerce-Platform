...
app.use('/api/v2/auth/login' , rateLimiter , require("./routing/V1/login") ) ;

app.use( '/api/v2/auth/refresh' , rateLimiter, require("./routing/V1/refresh"))

app.use( '/api/v2/auth/logout' , rateLimiter, require("./routing/V1/logout"));
